...
#            mailaddress = self.__GetPrimaryMail(token_user['token'])
...
#                j_ssh = api_ssh.Create(token_public_key['token'], mailaddress, ssh_key_gen_params['public_key'])
...
#                j_ssh = self.__GetGitHubSsh(args.username, token_public_key['token'], mailaddress, ssh_key_gen_params['public_key'])
            ...
            self.__db.account['AccessTokens'].insert(self.__CreateRecordToken(account['Id'], token))
